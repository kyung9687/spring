...
import com.kh.spring.exception.controller.AuthenticationException;
import com.kh.spring.exception.controller.InvalidParameterException;
...
public class BoardServiceImpl implements BoardService {
	...
	public int insertReply(ReplyDTO reply ,HttpSession session) {
		...
		String membetId =((MemberDTO)session.getAttribute("loginMember")).getMemberId();
		reply.setReplyWriter(membetId);
